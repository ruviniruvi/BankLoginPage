...
public class CreditCardFraudAlertsFrame extends JFrame {
	...
	public CreditCardFraudAlertsFrame() {
		...
		try {
			...
			Connection con=DriverManager.getConnection("jdbc:sqlserver://localhost:1433;database=BANK_DATABASE;integratedSecurity=true;");
			Statement stmt=con.createStatement();
			@SuppressWarnings("deprecation")
			String sql="Select * from USERS where EMPLOYEE_USER_NAME='" +txtID.getText()+"'";
